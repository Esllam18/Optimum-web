...
assert.match(source,/cad-route-dock-r2/);
assert.match(source,/cad-route-family/);
assert.match(source,/engineering-toggle-route-library/);
...
assert.match(css,/\.cad-route-dock-r2/);
assert.match(css,/\.cad-route-r2-grid/);
...
console.log('✓ Phase 4.16 final drawing adjustments: compact route-family dock, light element name and full movable route data editor passed');
