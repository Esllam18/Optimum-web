...
assert.match(app,/versioning=entitlementEnabled\('feature\.file_versioning'\)/);
assert.match(app,/const history=versioning\?/);
assert.match(app,/can_upload[^\n]{0,180}&&versioning\?`<button class="btn btn-primary" data-action="new-version"/);
