...
const active=['assets/app.js','assets/access-engine.js','assets/organization-os.js','assets/platform.js','assets/engineering.js','assets/operations-center.js','assets/site-supervisor.js','assets/project-control.js','assets/api.js'];
