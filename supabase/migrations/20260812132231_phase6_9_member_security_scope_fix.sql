...
declare
  ...
  s public.account_security%rowtype;
begin
  ...
  if not (
    ...
    raise exception 'Member security inspection permission required';
  end if;
  ...
  return jsonb_build_object(
    ...
    'temporary_password_expires_at',s.temporary_password_expires_at
  );
end;
$$;
